...
import { ArrowRight, ArrowUpRight, Calendar, Clock, Award, ShieldCheck, Heart } from "lucide-react";
        ...
        <div className="w-full max-w-[1920px] mx-auto">
          ...
          <div className="flex flex-col xl:flex-row gap-8">
            ...
            <div className="flex flex-col gap-6 w-full xl:flex-[690]">
              {/* Articles row on iPad, column on mobile/desktop */}
              <div className="flex flex-col md:flex-row xl:flex-col gap-6">
                {/* #1. Topmost Frame: Noticia Landing Page 1 */}
                <div className="w-full md:flex-1 min-h-[247px] rounded-[16px] bg-white/20 overflow-hidden">
                  {landingArticle1 && (
                    <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row w-full h-full">
                      {landingArticle1.image && (
                        <Link href={`/noticias/${landingArticle1.blogHandle}/${landingArticle1.handle}`} className="w-full sm:w-[220px] md:w-full lg:w-[220px] h-[200px] sm:h-auto md:h-[200px] lg:h-auto flex-shrink-0 relative block">
                          <Image
                      ...
                      <div className="flex flex-col flex-grow p-6 overflow-hidden">
                        ...
                        <div
                          className="prose prose-invert prose-sm overflow-y-auto max-h-[120px] sm:max-h-none md:max-h-[120px] lg:max-h-none flex-grow pr-2"
                ...
                <div className="w-full md:flex-1 min-h-[240px] rounded-[16px] bg-white/20 overflow-hidden">
                  {landingArticle2 && (
                    <div className="flex flex-col-reverse sm:flex-row md:flex-col-reverse lg:flex-row w-full h-full">
                      <div className="flex flex-col flex-grow p-6 overflow-hidden">
                      ...
                      {landingArticle2.image && (
                        <Link href={`/noticias/${landingArticle2.blogHandle}/${landingArticle2.handle}`} className="w-full sm:w-[220px] md:w-full lg:w-[220px] h-[200px] sm:h-auto md:h-[200px] lg:h-auto flex-shrink-0 relative block">
                          <Image
              ...
              {/* Frame 3: Bottommost — hidden on iPad */}
              <div className="w-full h-[48px] bg-white/10 rounded-lg overflow-hidden mt-auto md:hidden xl:block">
            ...
            {/* Middle + Rightmost wrapper — row on iPad, unwrapped on desktop */}
            <div className="flex flex-col md:flex-row xl:contents gap-6">
              {/* Middle Frame: Proportional to 552px */}
              <div className="flex flex-col gap-6 w-full md:flex-[3] xl:flex-[552]">
                <div className="flex flex-col w-full min-h-[511px] md:min-h-0 xl:min-h-[511px] bg-white/20 rounded-[16px] overflow-hidden">
              ...
              <div className="w-full md:flex-[2] xl:flex-[472] aspect-video sm:aspect-[16/9] xl:aspect-auto xl:min-h-[583px]">
            ...
            {/* Ver Más Recursos — iPad only */}
            <div className="hidden md:flex xl:hidden justify-center mt-2">
              <Link href="/noticias" className="flex items-center gap-2 text-white font-sans font-medium text-lg underline hover:opacity-80 transition-opacity">
                Ver Más Recursos
