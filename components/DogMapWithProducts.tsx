      ...
      <div className="flex xl:flex-row flex-col conatiner px-4 lg:px-20 py-4 lg:py-10 gap-4 items-center">
        ...
        <div className="flex flex-col gap-8 xl:basis-1/3">
          ...
          <div className="flex flex-col h-fit gap-8 lg:gap-[32px]">
            ...
            <div className="flex items-center justify-center gap-2 bg-[#2B4A7C] rounded-full px-4 py-2 w-98 h-13">                                                                     
              <div className="flex items-center justify-center w-4 h-4 rounded-full bg-[#8CC63F] shrink-0"/>                                                                            
              <h1 className="text-white font-bold text-2xl uppercase tracking-wide whitespace-nowrap text-justify">
                Marca #1 en México
              </h1>
            </div>
            ...
            <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 lg:flex lg:flex-row h-fit gap-8 lg:gap-[32px]">
